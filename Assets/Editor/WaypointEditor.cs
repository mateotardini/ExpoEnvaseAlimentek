...
public class WaypointEditor
{
    ...
    public static void OnDrawSceneGizmo(Waypoint waypoint, GizmoType gizmoType)
    {
        ...
        Gizmos.DrawLine(waypoint.transform.position + (waypoint.transform.position * waypoint.width / 2f), 
            waypoint.transform.position - (waypoint.transform.position * waypoint.width / 2f));
