...
public class BasicBehaviour : MonoBehaviour
{
	...
	void Update()
	{
		...
		//sprint = Input.GetButton (sprintButton); //boton para esprintiar y que la camara se corra hacia atras dando sensacion de velocidad
	...
	{
		lastDirection = direction;                       // <<<<----------------ESTO TIENE QUE VER CON EL MOVIMIENTO DE LA CAMARA AL GIRAR EL CUERPO.
	}
